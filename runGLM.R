...
## NOTE ##
# If you want to speed calculation up, please specify option "parallel=T" to BayesianGLM()
...
BayesianGLM(DATASET, GENE_FIG4A, parallel=T)
...
BayesianGLM(DATASET, GENE_FIG2G, parallel=T)
png("Fig2G.png")
...
BayesianGLM(DATASET, GENE_FIG2F, parallel=T)
png("Fig2F.png")
